...
public class BaseTest {
	...
	private static String SENDER = "radhikasham007@gmail.com";
	private static String RECIPIENT = "radhikasham007@gmail.com";
	private static String SUBJECT = "NAL OPEN CART Test Execution Report "
	...
	public void setup(String browser,String browserversion) {
		...
		prop=df.init_prop();
		//To set the config.properties file at run time, reading paramters from testng.xml file
	...
	public void sendTestReports() {
		...
		String bucket_name = "autoreportsbucket";
